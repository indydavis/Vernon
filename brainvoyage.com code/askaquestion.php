...
<html>
<head>
	<title>Ask a Question About Reality Begins with Consciousness</title>
...
<!-- ------------END HEADER------------ --><h1 class="title" align="center">Ask a Question on Reality Begins with Consciousness</h1><br><br>
...
<tr>
	...
	<input type="hidden" name="book" value="Reality Begins with Consciousness">
<img src="http://www.brainvoyage.com/images/securepic/word.jpg" /> <a name="pic" id="pic"></a><br>Enter the number you see above: <input type="text" name="secure_number"><br>
	<INPUT TYPE="submit" value="Send Mail"><INPUT TYPE="reset" value="Reset Form"></td>
</tr>
</table>
</FORM>
<H3 class="title" align=center>Thanks!</H3><br>
